...
router.put("/settings", asyncHandler(async (req, res) => {
  ...
  const brandingFields = [ "brand_name", "brand_logo_url", "brand_colors", "brand_fonts", "brand_favicon_url", "brand_og_image_url", "brand_terms_url", "brand_telegram_handle", "captcha_provider", "captcha_site_key", "safe_browsing_api_key" ];
