...
router.post("/", asyncHandler(async (req, res) => {
  ...
  const input = {
    ...
    custom_css: body.custom_css !== undefined ? String(body.custom_css).slice(0, 102400) : null,
    waf_bypass: body.waf_bypass !== undefined ? String(body.waf_bypass) : "none",
    block_ads: body.block_ads === true,
    subdomains: body.subdomains !== undefined ? store.normalizeSubdomainList(body.subdomains) : [],
...
router.put("/:id", asyncHandler(async (req, res) => {
  ...
  const changes = {
    ...
    custom_css: body.custom_css !== undefined ? String(body.custom_css).slice(0, 102400) : current.custom_css,
    csp_mode: body.csp_mode !== undefined ? normalizeCspMode(body.csp_mode, current.csp_mode) : current.csp_mode,
    waf_bypass: body.waf_bypass !== undefined ? String(body.waf_bypass) : current.waf_bypass,
    block_ads: body.block_ads !== undefined ? body.block_ads === true : current.block_ads,
    subdomains: body.subdomains !== undefined ? store.normalizeSubdomainList(body.subdomains) : current.subdomains,
    frozen: body.frozen !== undefined ? body.frozen === true : current.frozen
  };
