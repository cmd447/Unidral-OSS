    ...
    <div className="flex h-screen w-full overflow-hidden bg-canvas">
      ...
      <main className="scroll-thin relative flex-1 overflow-y-auto">
        ...
        <div className="mx-auto w-full max-w-[960px] px-[16px] pb-[80px] pt-[60px] md:px-[24px] md:pt-[72px]">
          ...
          {error ? (
            <div className="mb-[12px] border-l-2 border-error px-[8px] py-[6px] text-[12.5px] text-error">
              {error}
            </div>
          ) : null}
          ...
          {showForm ? (
            <Card className="mb-[14px] p-[16px]">
              ...
              <form onSubmit={handleCreate} className="space-y-[20px]">
                {}
                <div>
                  <div className="mb-[6px] text-[10.5px] font-semibold uppercase tracking-[0.08em] text-fg4">
                    Identity
                  </div>
                ...
                <div>
                  ...
                  <div className="mb-[8px] text-[12px] text-fg3">Mode</div>
                  <div className="flex gap-[20px] border-b border-line">
                    <button
                      type="button"
                      onClick={() => setFormMode("dev")}
                      className={cx(
                        "relative pb-[8px] text-[12.5px] font-medium transition-colors",
                        formMode === "dev" ? "text-fg" : "text-fg3 hover:text-fg"
                      )}
                    >
                      Dev (toolbar)
                      {formMode === "dev" ? (
                    ...
                    <button
                      ...
                      className={cx(
                        "relative pb-[8px] text-[12.5px] font-medium transition-colors",
                        formMode === "live" ? "text-fg" : "text-fg3 hover:text-fg"
                      )}
                    >
                      Live (clean)
                      {formMode === "live" ? (
                  ...
                  <div className="mt-[6px] text-[11px] text-fg4">
                  ...
                  <div className="mt-[14px] flex items-center justify-between py-[6px]">
                    <div>
                ...
                <div>
                  ...
                  <p className="text-[11.5px] text-fg4">
                    Direct egress — the proxy fetches content using this server's IP address.
                  </p>
                </div>
                {formError ? (
          ...
          {loading ? (
            <div className="border-t border-line px-[8px] py-[24px] text-center text-[12.5px] text-fg3">Loading sites…</div>
          ) : sites.length === 0 ? (
            <div className="border-t border-line px-[8px] py-[64px] text-center">
              <Globe className="mx-auto h-[26px] w-[26px] text-fg4" strokeWidth={1.5} />
              <div className="mt-[12px] text-[15px] font-medium text-fg">No sites yet</div>
              ...
              <BlueButton className="mt-[16px]" onClick={() => { resetForm(); setShowForm(true); }}>
                Add your first site
              </BlueButton>
            </div>
          ) : (
