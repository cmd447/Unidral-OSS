    ...
    <>
      ...
      <div className="min-h-screen bg-canvas text-fg">
        ...
        <div className="mx-auto max-w-[680px] px-[16px] py-[20px] md:px-[24px] md:py-[28px]">
          ...
          <div className="mb-[20px] flex items-center gap-[2px]">
            {STEPS.map((s, i) => {
              const Icon = s.icon;
              ...
              return (
                <React.Fragment key={s.id}>
                  <button
                    ...
                    className={cx(
                      "flex h-[26px] items-center gap-[5px] rounded-[5px] px-[8px] text-[11.5px] font-medium transition-colors",
                      isActive ? "bg-accent text-white" :
                      isDone ? "text-fg2 hover:bg-line" :
                      "text-fg4"
                    )}
                  >
                    {isDone ? <Check className="h-[12px] w-[12px]" strokeWidth={2} /> : <Icon className="h-[12px] w-[12px]" strokeWidth={1.8} />}
                    {s.label}
                  </button>
                  {i < STEPS.length - 1 && <ChevronRight className="h-[10px] w-[10px] text-fg4" strokeWidth={1.8} />}
                </React.Fragment>
              );
            })}
          </div>
          ...
          {step === 4 && (
            <div className="animate-pageIn space-y-[14px]">
              ...
              <Card className="divide-y divide-line">
                ...
                <ReviewRow label="Uni-Con" value="On" valueClass="text-success" />
                <ReviewRow label="WARP" value="On" valueClass="text-success" />
              </Card>
              ...
              <div className="flex items-center justify-between pt-[4px]">
                ...
                {initSuccess ? (
                  <a href={`https://${dashboardSubdomain}.${baseDomain}`} className="flex h-[30px] items-center gap-[6px] rounded-[7px] bg-accent px-[14px] text-[12.5px] font-semibold text-white transition-colors hover:bg-accentHover">
                    Open Dashboard <ArrowRight className="h-[12px] w-[12px]" strokeWidth={1.8} />
                  </a>
                ) : (
